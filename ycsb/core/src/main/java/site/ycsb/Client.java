...
public final class Client {
  ...
  private static void logResolvedRunConfig(Properties props) {
    boolean dotransactions =
        Boolean.valueOf(props.getProperty(DO_TRANSACTIONS_PROPERTY, String.valueOf(true)));

    System.err.println("YCSB resolved config:");
    System.err.println("  mode=" + (dotransactions ? "run" : "load"));
    System.err.println("  db=" + props.getProperty(DB_PROPERTY, "site.ycsb.BasicDB"));
    System.err.println("  workload=" + props.getProperty(WORKLOAD_PROPERTY, "<missing>"));
    System.err.println("  threadcount=" + props.getProperty(THREAD_COUNT_PROPERTY, "1"));
    System.err.println("  target=" + props.getProperty(TARGET_PROPERTY, "0"));
    System.err.println("  operationcount=" + props.getProperty(OPERATION_COUNT_PROPERTY, "0"));
    System.err.println("  recordcount=" + props.getProperty(RECORD_COUNT_PROPERTY, DEFAULT_RECORD_COUNT));
    System.err.println("  status=" + props.getProperty(STATUS_PROPERTY, String.valueOf(false)));
    System.err.println(
        "  GOOGLE_SPANNER_EXPERIMENTAL_LOCATION_API="
            + System.getenv("GOOGLE_SPANNER_EXPERIMENTAL_LOCATION_API"));
    System.err.println(
        "  SPANNER_DISABLE_GRPC_GCP_OTEL_METRICS="
            + System.getenv("SPANNER_DISABLE_GRPC_GCP_OTEL_METRICS"));
    System.err.println("  JAVA_TOOL_OPTIONS=" + System.getenv("JAVA_TOOL_OPTIONS"));
  }
