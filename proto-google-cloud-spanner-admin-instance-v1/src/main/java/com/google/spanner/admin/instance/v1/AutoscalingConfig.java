...
public final class AutoscalingConfig extends com.google.protobuf.GeneratedMessageV3
  ...
  public interface AutoscalingTargetsOrBuilder
     ...
     * from 0 (no utilization) to 100 (full utilization).
     * (-- TODO(b/269795300): Add a comment once the valid range of the cpu
     * utilization is finalized. --)
     * </pre>
     *
     * <code>int32 high_priority_cpu_utilization_percent = 1;</code>
     *
     ...
     * trying to achieve for the instance. This number is on a scale from 0 (no
     * utilization) to 100 (full utilization).
     * (-- TODO(b/269795300): Add a comment once the valid range of the storage
     * utilization is finalized. --)
     * </pre>
     *
     * <code>int32 storage_utilization_percent = 2;</code>
     *
