  ...
  static {
    java.lang.String[] descriptorData = {
      "\n=google/spanner/admin/database/v1/spann"
          ...
          + "ner.googleapis.com/Database\022<projects/{p"
          ...
          + "ption_config\030\004 \001(\01322.google.spanner.admi"
          + "n.database.v1.EncryptionConfigB\004\342A\001\001\022Q\n\020"
          + "database_dialect\030\005 \001(\01621.google.spanner."
          + "admin.database.v1.DatabaseDialectB\004\342A\001\001\""
          ...
          + "\001(\0132*.google.spanner.admin.database.v1.D"
          + "atabaseB\004\342A\001\002\0225\n\013update_mask\030\002 \001(\0132\032.goo"
          + "gle.protobuf.FieldMaskB\004\342A\001\002\"\332\001\n\026UpdateD"
          + "atabaseMetadata\022H\n\007request\030\001 \001(\01327.googl"
          + "e.spanner.admin.database.v1.UpdateDataba"
          + "seRequest\022E\n\010progress\030\002 \001(\01323.google.spa"
          ...
          + " \003(\0132\032.google.protobuf.Timestamp\022\027\n\tthro"
          + "ttled\030\004 \001(\010B\004\342A\001\003\022E\n\010progress\030\005 \003(\01323.go"
          + "ogle.spanner.admin.database.v1.Operation"
          + "Progress\022I\n\007actions\030\006 \003(\01328.google.spann"
          + "er.admin.database.v1.DdlStatementActionI"
          + "nfo\"Q\n\023DropDatabaseRequest\022:\n\010database\030\001"
          + " \001(\tB(\342A\001\002\372A!\n\037spanner.googleapis.com/Da"
          + "tabase\"S\n\025GetDatabaseDdlRequest\022:\n\010datab"
          + "ase\030\001 \001(\tB(\342A\001\002\372A!\n\037spanner.googleapis.c"
          + "om/Database\",\n\026GetDatabaseDdlResponse\022\022\n"
          + "\nstatements\030\001 \003(\t\"\220\001\n\035ListDatabaseOperat"
          + "ionsRequest\0228\n\006parent\030\001 \001(\tB(\342A\001\002\372A!\n\037sp"
          + "anner.googleapis.com/Instance\022\016\n\006filter\030"
          + "\002 \001(\t\022\021\n\tpage_size\030\003 \001(\005\022\022\n\npage_token\030\004"
          ...
          + "\022b\n\021encryption_config\030\004 \001(\0132A.google.spa"
          + "nner.admin.database.v1.RestoreDatabaseEn"
          + "cryptionConfigB\004\342A\001\001B\010\n\006source\"\365\002\n\037Resto"
          + "reDatabaseEncryptionConfig\022o\n\017encryption"
          ...
          + "es/*/databases/*}:setIamPolicy:\001*ZA\"</v1"
          + "/{resource=projects/*/instances/*/backup"
          + "s/*}:setIamPolicy:\001*\022\344\001\n\014GetIamPolicy\022\"."
          + "google.iam.v1.GetIamPolicyRequest\032\025.goog"
          + "le.iam.v1.Policy\"\230\001\332A\010resource\202\323\344\223\002\206\001\">/"
          + "v1/{resource=projects/*/instances/*/data"
          + "bases/*}:getIamPolicy:\001*ZA\"</v1/{resourc"
          + "e=projects/*/instances/*/backups/*}:getI"
          + "amPolicy:\001*\022\367\002\n\022TestIamPermissions\022(.goo"
          + "gle.iam.v1.TestIamPermissionsRequest\032).g"
          + "oogle.iam.v1.TestIamPermissionsResponse\""
          + "\213\002\332A\024resource,permissions\202\323\344\223\002\355\001\"D/v1/{r"
          + "esource=projects/*/instances/*/databases"
          + "/*}:testIamPermissions:\001*ZG\"B/v1/{resour"
          + "ce=projects/*/instances/*/backups/*}:tes"
          + "tIamPermissions:\001*ZY\"T/v1/{resource=proj"
          + "ects/*/instances/*/databases/*/databaseR"
          + "oles/*}:testIamPermissions:\001*\022\237\002\n\014Create"
          ...
          + ".database.v1.Backup\0225google.spanner.admi"
          + "n.database.v1.CreateBackupMetadata\332A\027par"
          + "ent,backup,backup_id\202\323\344\223\0025\"+/v1/{parent="
          + "projects/*/instances/*}/backups:\006backup\022"
          + "\254\002\n\nCopyBackup\0223.google.spanner.admin.da"
          + "tabase.v1.CopyBackupRequest\032\035.google.lon"
          + "grunning.Operation\"\311\001\312A^\n\'google.spanner"
          + ".admin.database.v1.Backup\0223google.spanne"
          + "r.admin.database.v1.CopyBackupMetadata\332A"
          + "*parent,backup_id,source_backup,expire_t"
          + "ime\202\323\344\223\0025\"0/v1/{parent=projects/*/instan"
          + "ces/*}/backups:copy:\001*\022\245\001\n\tGetBackup\0222.g"
          + "oogle.spanner.admin.database.v1.GetBacku"
          + "pRequest\032(.google.spanner.admin.database"
          + ".v1.Backup\":\332A\004name\202\323\344\223\002-\022+/v1/{name=pro"
          + "jects/*/instances/*/backups/*}\022\310\001\n\014Updat"
          + "eBackup\0225.google.spanner.admin.database."
          + "v1.UpdateBackupRequest\032(.google.spanner."
          + "admin.database.v1.Backup\"W\332A\022backup,upda"
          + "te_mask\202\323\344\223\002<22/v1/{backup.name=projects"
          + "/*/instances/*/backups/*}:\006backup\022\231\001\n\014De"
          + "leteBackup\0225.google.spanner.admin.databa"
          + "se.v1.DeleteBackupRequest\032\026.google.proto"
          + "buf.Empty\":\332A\004name\202\323\344\223\002-*+/v1/{name=proj"
          + "ects/*/instances/*/backups/*}\022\270\001\n\013ListBa"
          + "ckups\0224.google.spanner.admin.database.v1"
          + ".ListBackupsRequest\0325.google.spanner.adm"
          + "in.database.v1.ListBackupsResponse\"<\332A\006p"
          + "arent\202\323\344\223\002-\022+/v1/{parent=projects/*/inst"
          + "ances/*}/backups\022\261\002\n\017RestoreDatabase\0228.g"
          + "oogle.spanner.admin.database.v1.RestoreD"
          + "atabaseRequest\032\035.google.longrunning.Oper"
          + "ation\"\304\001\312Ae\n)google.spanner.admin.databa"
          + "se.v1.Database\0228google.spanner.admin.dat"
          + "abase.v1.RestoreDatabaseMetadata\332A\031paren"
          + "t,database_id,backup\202\323\344\223\002:\"5/v1/{parent="
          + "projects/*/instances/*}/databases:restor"
          + "e:\001*\022\344\001\n\026ListDatabaseOperations\022?.google"
          + ".spanner.admin.database.v1.ListDatabaseO"
          + "perationsRequest\032@.google.spanner.admin."
          + "database.v1.ListDatabaseOperationsRespon"
          + "se\"G\332A\006parent\202\323\344\223\0028\0226/v1/{parent=project"
          + "s/*/instances/*}/databaseOperations\022\334\001\n\024"
          + "ListBackupOperations\022=.google.spanner.ad"
          + "min.database.v1.ListBackupOperationsRequ"
          + "est\032>.google.spanner.admin.database.v1.L"
          ...
          + "s\022\332\001\n\024CreateBackupSchedule\022=.google.span"
          + "ner.admin.database.v1.CreateBackupSchedu"
          + "leRequest\0320.google.spanner.admin.databas"
          + "e.v1.BackupSchedule\"Q\202\323\344\223\002K\"F/v1/{parent"
          + "=projects/*/instances/*/databases/*}/bac"
          + "kups:createSchedule:\001*\022\220\002\n\024UpdateBackupS"
          + "chedule\022=.google.spanner.admin.database."
          + "v1.UpdateBackupScheduleRequest\0320.google."
          + "spanner.admin.database.v1.BackupSchedule"
          + "\"\206\001\332A\033backup_schedule,update_mask\202\323\344\223\002b2"
          + "O/v1/{backup_schedule.name=projects/*/in"
          + "stances/*/databases/*/backupSchedules/*}"
          + ":\017backup_schedule\022\321\001\n\021GetBackupSchedule\022"
          + ":.google.spanner.admin.database.v1.GetBa"
          + "ckupScheduleRequest\0320.google.spanner.adm"
          + "in.database.v1.BackupSchedule\"N\332A\004name\202\323"
          + "\344\223\002A\022?/v1/{name=projects/*/instances/*/d"
          + "atabases/*/backupSchedules/*}\022\265\001\n\024Delete"
          + "BackupSchedule\0225.google.spanner.admin.da"
          ...
          + "s/*/instances/*/databases/*}/backups:sch"
          + "edules\032x\312A\026spanner.googleapis.com\322A\\http"
          + "s://www.googleapis.com/auth/cloud-platfo"
          + "rm,https://www.googleapis.com/auth/spann"
          + "er.adminB\330\002\n$com.google.spanner.admin.da"
          + "tabase.v1B\031SpannerDatabaseAdminProtoP\001ZF"
          + "cloud.google.com/go/spanner/admin/databa"
          + "se/apiv1/databasepb;databasepb\252\002&Google."
          + "Cloud.Spanner.Admin.Database.V1\312\002&Google"
          + "\\Cloud\\Spanner\\Admin\\Database\\V1\352\002+Googl"
          + "e::Cloud::Spanner::Admin::Database::V1\352A"
          + "J\n\037spanner.googleapis.com/Instance\022\'proj"
          + "ects/{project}/instances/{instance}b\006pro"
          + "to3"
    };
    descriptor =
